![docker image](https://github.com/RossKnapman/nomad-distro-workshop/actions/workflows/docker-publish.yml/badge.svg)


# RossKnapman's NOMAD Oasis Distribution

This is the NOMAD Oasis distribution of RossKnapman.
...
2. Clone the repository or download the repository as a zip file.
    ...
    ```sh
    git clone https://github.com/RossKnapman/nomad-distro-workshop.git
    cd nomad-distro-workshop
    ```

    or

    ```sh
    curl-L -o nomad-distro-workshop.zip "https://github.com/RossKnapman/nomad-distro-workshop/archive/main.zip"
    unzip nomad-distro-workshop.zip
    cd nomad-distro-workshop
    ```
...
your `docker-compose.yaml` with `ghcr.io/rossknapman/nomad-distro-workshop:main` for the services
...
and advanced configuration, see the [nomad-helm-charts](https://github.com/RossKnapman/nomad-helm-charts) repository.
...
By default, no plugins are included in this distribution. You can find a list of available NOMAD plugins [here](https://nomad-lab.eu/prod/v1/oasis/gui/search/plugins). For a list of official plugins provided by FAIRmat, please see [here](https://github.com/RossKnapman/.github/blob/main/profile/README.md). For inspiration, you can also check the list of [plugins that are installed on the production NOMAD deployment hosted by FAIRmat](https://gitlab.mpcdf.mpg.de/nomad-lab/nomad-distro/-/raw/main/pyproject.toml?ref_type=heads).
...
```sh
docker pull ghcr.io/rossknapman/nomad-distro-workshop/jupyter:main
```
...
By default, documentation is built using the [nomad-docs](https://github.com/RossKnapman/nomad-docs) repository. However, if you'd like to customize the documentation for your Oasis instance, you can easily do so.

1. First, [fork the nomad-docs repository](https://github.com/RossKnapman/nomad-docs/fork).
...
_I get an_ `Error response from daemon: Head "https://ghcr.io/v2/RossKnapman/nomad-distro-workshop/manifests/main": unauthorized`
